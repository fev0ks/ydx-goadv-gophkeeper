...
# TODO don't know why internal path to protoeditor is required
	protoc -I C:/Users/mixa1/AppData/Local/JetBrains/GoLand2022.2/protoeditor --proto_path=api/proto  --go_out=pkg/pb --go_opt=paths=source_relative --go-grpc_out=pkg/pb --go-grpc_opt=paths=source_relative api/proto/*.proto
